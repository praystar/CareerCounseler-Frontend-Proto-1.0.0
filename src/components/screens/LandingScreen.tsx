...
import { Compass, TrendingUp, Users, Award, ArrowRight, CheckCircle } from 'lucide-react';
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="relative">
              ...
              <p className="text-gray-600">Complete a comprehensive form about your interests, academics, and background</p>
            </div>
            <div className="relative">
              ...
              <p className="text-gray-600">Our AI processes your data with market trends and career requirements</p>
            </div>
            <div className="relative">
              ...
              <p className="text-gray-600">Receive detailed career recommendations and a personalized roadmap</p>
            </div>
          </div>
        </div>
      </div>
